...
# Tesseract executable path (if need be)
pytesseract.pytesseract.tesseract_cmd = '/usr/bin/tesseract'  # make sure this is the correct path
...
if not file_path:
    ...
    exit()  # or return, depending on the flow of your program
